...
def main():
    ...
    parser.add_argument('--epochs', type=int, default=2, help='Количество эпох (уменьшено для дообучения)')
    parser.add_argument('--batch_size', type=int, default=1, help='Размер батча (1 для стабильности)')
    parser.add_argument('--gradient_accumulation_steps', type=int, default=16, help='Шаги накопления градиента (увеличено для эффективности)')
    parser.add_argument('--learning_rate', type=float, default=5e-6, help='Скорость обучения (уменьшена для дообучения)')
